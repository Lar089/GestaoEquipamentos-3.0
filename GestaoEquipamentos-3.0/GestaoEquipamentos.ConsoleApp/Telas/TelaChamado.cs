...
namespace GestaoEquipamentos.ConsoleApp.Telas
{
    class TelaChamado : TelaBase
    {
        ...
        public TelaChamado(TelaEquipamento telaE, ControladorChamado controlador, TelaSolicitante telaS)//ControladorEquipamento controladorE, ControladorChamado controlador, ControladorSolicitante controladorS
